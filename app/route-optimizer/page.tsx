...
export default function RouteOptimizerPage() {
  useEffect(() => {
    // Redirect to external route optimization service
    const timer = setTimeout(() => {
      window.open("https://quanta-path-setup.vercel.app/", "_blank")
    }, 2000)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <Route className="h-12 w-12 text-emerald-600 mr-3" />
            <h1 className="text-4xl font-bold text-gray-900">Route Optimizer</h1>
          </div>
        ...
        <Card className="mb-8 border-2 border-emerald-200">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-emerald-700">Quantum Path Setup</CardTitle>
            <CardDescription className="text-lg">
              Redirecting you to our advanced route optimization platform...
            </CardDescription>
          </CardHeader>
          <CardContent className="text-center space-y-6">
            ...
            <p className="text-gray-600">
              You will be redirected to our quantum-powered route optimization service in 2 seconds.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="text-center">
            <CardHeader>
              <Fuel className="h-8 w-8 text-emerald-600 mx-auto mb-2" />
              <CardTitle className="text-lg">Fuel Efficiency</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">Minimize fuel consumption and carbon footprint with smart route planning.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-gradient-to-r from-emerald-50 to-blue-50">
          <CardContent className="p-6">
            <h3 className="text-xl font-semibold mb-3 text-gray-800">Why Use Our Route Optimizer?</h3>
